package com.anningtex.anlogkotlin.weight.actionbar;
...
import com.anningtex.anlogkotlin.weight.actionbar.style.BaseTitleBarStyle;
import com.anningtex.anlogkotlin.weight.actionbar.style.TitleBarLightStyle;
import com.anningtex.anlogkotlin.weight.actionbar.style.TitleBarNightStyle;
import com.anningtex.anlogkotlin.weight.actionbar.style.TitleBarRippleStyle;
import com.anningtex.anlogkotlin.weight.actionbar.style.TitleBarTransparentStyle;
...
public class TitleBar extends FrameLayout implements View.OnClickListener, Runnable {
    ...
    private ILeftListener leftListener;
    private IRightListener mIRightListener;
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRightView.setOnClickListener(view -> {
            if (mIRightListener != null) {
                mIRightListener.onRightClick(view);
            }
        });
    }

    public void setLeftListener(ILeftListener leftListener) {
        this.leftListener = leftListener;
    }

    public void setRightListener(IRightListener rightFListener) {
        this.mIRightListener = rightFListener;
    }
