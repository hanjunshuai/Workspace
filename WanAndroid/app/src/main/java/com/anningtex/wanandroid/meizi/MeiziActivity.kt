package com.anningtex.wanandroid.meizi
...
import com.anningtex.wanandroid.meizi.presenter.MeiziPresenter
...
class MeiziActivity : BaseMVPActivity<MeiziContract.View, MeiziPresenter>(), MeiziContract.View {
    ...
    override fun getLayoutResId(): Int = R.layout.activity_meizi

    override fun createPresenter(): MeiziPresenter = MeiziPresenter()
