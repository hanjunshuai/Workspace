...
//            AbsoluteLayout.LayoutParams showingViewLayoutParams = new AbsoluteLayout.LayoutParams((int) mOriginWidth, (int) mOriginWidth, 0, 0);
            FrameLayout.LayoutParams showingViewLayoutParams = new FrameLayout.LayoutParams((int) mOriginWidth, (int) mOriginWidth);
            showingViewLayoutParams.gravity = Gravity.CENTER;
