...
internal class ChooseFileHighPolicy : IChooseFilePolicy {
    ...
    override fun getFileList(
        ...
        val uri = DocumentsContract.buildChildDocumentsUri(
            "com.anning.lib_file.authorities",
            rootPath
        )
        ...
        ChooseFile.config?.mExecutor?.execute {
            ...
            val cursor =
                ChooseFile.activityRef?.get()?.contentResolver?.query(uri, null, null, null, null)
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    val fileLastUpdateTime =
                        cursor.getString(cursor.getColumnIndex("fileLastUpdateTime"))
                    ...
                    Log.e("TAG", "isTop : $isTop , isRoot : $isRoot")
