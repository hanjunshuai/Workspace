...
import com.anning.projectdoc.lib.content.ZFileQWBean;
...
public class ZFileQWActivity extends ZFileActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        zfileQwToolBar = findViewById(R.id.zfile_qw_toolBar);
        zfileQwTabLayout = findViewById(R.id.zfile_qw_tabLayout);
        zfileQwViewPager = findViewById(R.id.zfile_qw_viewPager);
    }
    ...
    private void initAll() {
        ...
        zfileQwToolBar.setOnMenuItemClickListener(item -> {
            menuItemClick(item);
            return false;
        });
        zfileQwToolBar.setNavigationOnClickListener(v -> onBackPressed());
