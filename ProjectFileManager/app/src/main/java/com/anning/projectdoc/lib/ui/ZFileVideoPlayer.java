...
public class ZFileVideoPlayer extends TextureView implements TextureView.SurfaceTextureListener {
        ...
        if (player == null) {
            ...
            player.setOnBufferingUpdateListener(new MediaPlayer.OnBufferingUpdateListener() {
                ...
                public void onBufferingUpdate(MediaPlayer mp, int percent) {
                    Log.e("ZFileManageHelp", String.format("缓存中：%d", percent));
                }
            });
            player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mp) {
                    Log.e("ZFileManageHelp", "播放完成");
                    play();
                }
            });
    ...
    public void play() {
        ...
        if (videoPath.isEmpty()) {
            Log.e("ZFileManageHelp", "视频播放地址不能为空");
            return;
        }
        if (isPlaying()) {
            Log.e("ZFileManageHelp", "视频正在播放...");
            return;
        }
        try {
            if (isPause()) {
            ...
            e.printStackTrace();
            Log.e("ZFileManageHelp", "播放失败！视频路径为：$videoPath");
        }
    }
